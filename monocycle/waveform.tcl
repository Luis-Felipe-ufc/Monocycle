...
probe -create -database waves monociclo_tb.clk monociclo_tb.reset monociclo_tb.DUT.DTP.pc_out monociclo_tb.DUT.DTP.instruction monociclo_tb.DUT.DTP.RF.registers monociclo_tb.DUT.DM.memory

simvision -input waveform.tcl.tcl
